...
FitnessOS follows a domain-oriented logical schema architecture.

Each domain maintains its own authoritative Schema Architecture within its domain-specific `SCHEMA_ARCHITECTURE.md`.

The enterprise Schema Architecture defines the standards, principles, ownership model, boundary rules, dependency strategy, and governance for logical schemas across FitnessOS.

Domain-specific logical schema implementations SHALL NOT be duplicated within this document.
---
